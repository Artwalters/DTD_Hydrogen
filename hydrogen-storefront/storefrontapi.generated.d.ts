...
export type MoreProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle' | 'productType'
> & {
  priceRange: {
...
export type MoreProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type MoreProductsQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle' | 'productType'> & {
        priceRange: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment MoreProduct on Product {\n    id\n    title\n    handle\n    productType\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    options {\n      name\n      optionValues {\n        name\n        swatch {\n          color\n        }\n      }\n    }\n  }\n  query MoreProducts ($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 3, sortKey: CREATED_AT, reverse: true) {\n      nodes {\n        ...MoreProduct\n      }\n    }\n  }\n': {
    return: MoreProductsQuery;
    variables: MoreProductsQueryVariables;
  };
